...
function DubboMultiCulturalGala22024Photos() {
    ...
    <div className="">
      ...
      <div className="carousel md:w-[600px] w-80 h-[600px] relative overflow-hidden">
        {Array.from({ length: totalSlides }, (_, i) => (
          ...
          >
            <Image
              src={`/assets/images/DubboMultiCulturalGala22024/${i + 1}.jpg`}
              width={600}
              height={600}
              className=""
              alt={`Multicultural Gala 2 Image ${i + 1}`}
            />
...
export default DubboMultiCulturalGala22024Photos;
