...
function AutumnHolidayYouthProgramPhotos() {
    ...
    <div className="">
      ...
      <div className="carousel md:w-[600px] w-80 h-[600px] relative overflow-hidden">
        {Array.from({ length: totalSlides }, (_, i) => (
          ...
          >
            <Image
              src={`/assets/images/AutumnHolidayYouthProgram/${i + 1}.jpeg`}
              width={600}
              height={600}
              className=""
              alt={`Autumn Holiday Youth Program Image ${i + 1}`}
            />
...
export default AutumnHolidayYouthProgramPhotos;
