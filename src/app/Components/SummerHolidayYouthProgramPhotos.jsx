...
function SummerHolidayYouthProgramPhotos() {
    ...
    <div className="">
      ...
      <div className="carousel md:w-[600px] w-80 h-[600px] relative overflow-hidden">
        {Array.from({ length: totalSlides }, (_, i) => (
          ...
          >
            <Image
              src={`/assets/images/SummerHolidayYouthProgram/${i + 1}.jpeg`}
              width={600}
              height={600}
              className=""
              alt={`Summer Holiday Youth Program Image ${i + 1}`}
            />
...
export default SummerHolidayYouthProgramPhotos;
