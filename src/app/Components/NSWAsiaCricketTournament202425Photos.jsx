...
function NSWAsiaCricketTournament202425Photos() {
  const [currentSlide, setCurrentSlide] = useState(1);

  const totalSlides = 46;
    ...
    <div className="">
      ...
      <div className="carousel md:w-[600px] w-80 h-[600px] relative overflow-hidden">
        {Array.from({ length: totalSlides }, (_, i) => (
          ...
          >
            <Image
              src={`/assets/images/NSWAsiaCricketTournament202425Photos/${
                i + 1
              }.jpeg`}
              width={600}
              height={600}
...
export default NSWAsiaCricketTournament202425Photos;
