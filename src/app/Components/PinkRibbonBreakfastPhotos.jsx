...
function PinkRibbonBreakfastPhotos() {
    ...
    <div className="">
      ...
      <div className="carousel md:w-[600px] w-80 h-[600px] relative overflow-hidden">
        {Array.from({ length: totalSlides }, (_, i) => (
          ...
          >
            <Image
              src={`/assets/images/PinkRibbonBreakfast/${i + 1}.jpeg`}
              width={600}
              height={600}
              className=""
              alt={`Pink Ribbon Breakfast Image ${i + 1}`}
            />
...
export default PinkRibbonBreakfastPhotos;
