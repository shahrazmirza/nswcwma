...
import NSWAsiaCricketTournament202425Photos from "../../../Components/NSWAsiaCricketTournament202425Photos";

function NSWAsiaCricketTournament202425() {
  ...
  const filterInclude = "New South Wales Asia Cricket Tournament 2024/25";
              ...
              .map((item) => (
                <div key={item.id}>
                  ...
                  <div className="md:-mb-32 -mb-80">
                    <NSWAsiaCricketTournament202425Photos />
                  </div>
                  {items
                    .filter((item) => item.title === filterInclude)
                    .map((item) => (
...
export default NSWAsiaCricketTournament202425;
