...
import DubboMultiCulturalGala22024Photos from "../../../Components/DubboMultiCulturalGala22024Photos";

function DubboMultiCulturalGala22024() {
  ...
  const filterInclude = "Dubbo Multi Cultural Gala - II - 2024";
              ...
              .map((item) => (
                <div key={item.id}>
                  ...
                  <div className="md:-mb-32 -mb-80">
                    <DubboMultiCulturalGala22024Photos />
                  </div>
                  {items
                    .filter((item) => item.title === filterInclude)
                    .map((item) => (
...
export default DubboMultiCulturalGala22024;
